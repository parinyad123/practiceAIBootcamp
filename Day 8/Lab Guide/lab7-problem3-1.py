...
'''
Step 6: Plot learning curves for the polynomial features with lambda in Lambda
'''
...
plt.plot(range(11), J_cv_optimal_lambda, label="Cross Validation")
plt.title("Visualizing the effect of lambda")
plt.xlabel("Lambda")
plt.ylabel("Cost")
plt.legend()
