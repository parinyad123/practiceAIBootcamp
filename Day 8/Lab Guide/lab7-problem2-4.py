...
plt.plot(range(12), J_cv_polynomial_lambda1, label="Cross Validation (lambda = 1)")
plt.title("Learning Curve for Linear Regression")
plt.xlabel("Number of training examples")
plt.ylabel("Error")
plt.legend()
...
plt.plot(range(12), J_cv_polynomial_lambda100, label="Cross Validation (lambda = 100)", linestyle='dashed')
plt.title("Learning Curve for Linear Regression")
plt.xlabel("Number of training examples")
plt.ylabel("Error")
plt.legend()
