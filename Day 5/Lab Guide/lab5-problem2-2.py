...
'''
np.linalg.inv(X.T * X +lambda + identity_matrix) * X.T
# Hirt: you many have to write more than one lines of code
# Also, see https://docs.scipy.org/doc/numpy-1.15.0/reference/generated/numpy.eye.html to understand how 
# an identity matrix can be constructed 
# 
# estimated_theta should hold the resulting thetas !
...
plt.plot(data.T[0], estimated_theta.item(0),
         estimated_theta.item(1) * data.T[0],'b', label='Fitted line') # Put your code in place of ............
...
# จากกราฟจะเห็นว่าค่า lambda มากๆๆ จะได้กราฟที่เข้าใกล้การขนานกับแกน x