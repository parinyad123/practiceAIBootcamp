...
def costfunction(Theta1, Theta2, X_with_bias, y_one_hot, lambda_param):
    ...
    delta3 = a3.T - y_one_hot # (y_one_hot size 5000)  --> 5000 x 10 dim
    # Put your code here (this is step#2 on page#5)
    delta2 = Theta2[:,1:].T.dot(delta3.T) * sigmoidGradient(z2)
    # Put your code here (this is step#3 on page#5)
