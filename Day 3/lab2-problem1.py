...
'''
# ใส่เข้าไปเพื่อไม่ให้มันโชว์ว่า com ของคุณมี cpu คุณควรใช้
...
'''
loss_function = tf.multiply(tf.divide(1, 2), tf.reduce_mean(tf.pow(Y - hypothesis_function, 2))) # reduce_mean = หาค่าเฉลี่ย

'''
Step 6: Using gradient descent with learning rate of 0.001 to minimize loss
'''
optimizer = tf.train.GradientDescentOptimizer(learning_rate=0.001).minimize(loss_function)
# บอกว่า กำลังแก้ปัญหา minimize ของ loss fn.
